<style>
    ...
    .midAutumn .jz {
        width: 100%;
        height: 25px;
        background: url(../../../vue_static/img/jz.png);
    ...
    .midAutumn .jz_content_close {
        width: 100%;
        height: 8px;
        background: url(../../../vue_static/img/jz_content.png);
        background-size: 100% 100%;
    }
    
    .midAutumn .jz_content_open {
        width: 100%;
        background: url(../../../vue_static/img/jz_open.png);
        background-size: 100% 100%;
        overflow-y: hidden;
    }
    ...
    .midAutumn .jz_content_open .question_content .question_end .sennbtn {
        ...
        text-align: center;
        line-height: 40px;
        background: url(../../../vue_static/img/sendbtn.png);
        color: rgb(74, 32, 37);
        font-size: 13px;
        background-size: 100% 100%;
    }
    ...
    .midAutumn .rbtn {
        ...
        height: 35px;
        margin: 0 auto;
        background: url(../../../vue_static/img/rbtn.png) no-repeat;
        background-size: 100% 100%;
        margin-top: 20px;
        color: rgb(74, 32, 37);
        text-align: center;
    ...
    .midAutumn .yqpm {
        width: 100%;
        height: 350px;
        background: url(../../../vue_static/img/pm.png) no-repeat;
        background-size: 100% 100%;
        margin-top: 20px;
    }
    ...
    .midAutumn .yqbtn .rbtn-s {
        width: 45%;
        height: 35px;
        background: url(../../../vue_static/img/rbtn.png);
        background-size: 100% 100%;
        text-align: center;
        line-height: 35px;
        color: rgb(74, 32, 37);
    ...
    .midAutumn .yqbtn .gbtn-s {
        width: 45%;
        height: 35px;
        background: url(../../../vue_static/img/gbtn.png);
        background-size: 100% 100%;
        text-align: center;
        line-height: 35px;
        color: rgb(44, 80, 62);
    ...
    .midAutumn .jz_content_open .question_content .btns .bbtn {
        ...
        line-height: 35px;
        color: rgb(29, 53, 79);
        background: url(../../../vue_static/img/use.png);
        background-size: 100% 100%;
        float: right;
        margin-top: 10px;
        font-size: 12px;
    ...
    .midAutumn .jz_content_open .question_content .question_rule {
        ...
        background: url(../../../vue_static/img/q_rule.png);
        background-size: 100% 100%;
    }
...
<template>
    <div class="midAutumn">
        ...
        <!--comfirm-end-->
        <div class="head">
            <img src="../../../vue_static/img/title.png" />
        </div>
        <div class="jz"></div>
        ...
        <div v-if="isOpen" class="jz_content_open" transition="jz_content_open">
            <div class="question_content" v-if="!isFinished">
                <div class="question" v-for="question in questions">
                    <div class="question_title">{{questions.indexOf(question) + 1}}.{{question.title}}</div><div class="question_options"><div class="question_option fl" v-touch:tap="active(questions.indexOf(question) + 1, $event)">{{question.options[0]}}</div><div class="question_option fr" v-touch:tap="active(questions.indexOf(question) + 1, $event)">{{question.options[1]}}</div><div class="question_option fl mt10" v-touch:tap="active(questions.indexOf(question) + 1, $event)">{{question.options[2]}}</div><div class="question_option fr mt10" v-touch:tap="active(questions.indexOf(question) + 1, $event)">{{question.options[3]}}</div></div>
                </div>
                    ...
                    <div class="left_autumn">
                        ...
                        <span class="bottom" v-if="!hasChange && (h_score !== 0)">
                            <span style="font-weight: bold;">
                                ...
                                <span v-if="(h_score == 3)">188.15</span>
                                元抵扣红包已经躺在您的账户啦，赶快去使用吧
                            </span>
                        </span>
                    </div>
                    <div class="right">
                        <span class="top">
                            <img v-if="(designation == '举人')" src="/vue_static/img/icon_03.png"/>
                            <img v-if="(designation == '秀才')" src="/vue_static/img/icon_04.png"/>
                            <img v-if="(designation == '状元')" src="/vue_static/img/icon_05.png"/>
                            <img v-if="(designation == '榜眼')" src="/vue_static/img/icon_06.png"/>
                            <img v-if="(designation == '探花')" src="/vue_static/img/icon_07.png"/>
                        </span>
        ...
        <div class="cm_rule">
            <img src="../../../vue_static/img/cm_rule.png" />
        </div>
        <div class="gift">
            <img src="../../../vue_static/img/gift.png" />
        </div>
        ...
        <div class="rule">
            <img src="../../../vue_static/img/rule.png"/>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            active: function (no, event) {
                ...
                var s = event.target.parentNode.childNodes;
